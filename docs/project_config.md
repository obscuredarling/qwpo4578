...
For most build tools or utilities in the **Build Settings** section, the interface includes:
  ...
  - **Misc Args**: Allows you to specify additional or specialized options for the tool or utility. For supported options by the selected toolchain, see [**Toolchains**](./components.md#toolchains).
