...
1. Download the RVBuilder extension package `rvbuilder-1.0.0.vsix` from the [**RVBuilder latest release page**](https://github.com/andestech/RVBuilder/releases/tag/v1.0.0).  
